...
def model_config(parser):
    """Model arguments"""
    parser.add_argument("--base_model", type=str, default="yahma/llama-7b-hf", help="base model used for the generator, default to yahma/llama-7b-hf")
    parser.add_argument("--load_8bit", type=bool, default=False, help="whether to load the 8bit model, default to False")
    parser.add_argument("--source_lora_weights", type=str, default="/home/llmtrainer/KW2G/model/KW2G_model", help="path to the source lora weights, default to $RESOURCE_LORA_WEIGHTS")
    ...
    parser.add_argument("--check_only", type=bool, default=True, help="whether to use check only (validator), default to False")
    parser.add_argument("--check_threshold", type=float, default=1.7, help="check threshold for the generator, default to 1.7")

    # score model path (PEFT)
    parser.add_argument("--score_lora_weights", type=str, default="/home/llmtrainer/KW2G/model/score", help="path to the score checkpoint, default to $WEBGLM_SCORE_CKPT")

    # retriver and generator model path (From WebGLM if you want to use the contriever)
    # parser.add_argument("--webglm_ckpt_path", type=str, default=None, help="path to the webglm checkpoint, default to $WEBGLM_CKPT or THUDM/WebGLM")
    ...
    parser.add_argument("--retrieval_instruction", type=str, default="[Resource Retrieval] Retrieving five web sources that fulfill the user's requirement.", help="instructions for the retrieval model")
    ...
    parser.add_argument("--critical_instruction", type=str, default="[Resource Correction] Modifying retrieved sources based on user queries and suggestions.", help="instructions for the critical model")
...
def data_config(parser):
    ...
    # log path
    parser.add_argument("--log_dir", type=str, default="/home/llmtrainer/KW2G/log/", help="path to the log directory, default to $LOG_DIR")
    
    # result path
    parser.add_argument("--result_dir", type=str, default="/home/llmtrainer/KW2G/result/", help="path to the result directory, default to $RESULT_DIR")
    return parser
